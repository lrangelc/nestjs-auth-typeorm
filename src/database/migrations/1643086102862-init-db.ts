...
export class initDb1643086102862 implements MigrationInterface {
    name = 'initDb1643086102862'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            CREATE TABLE "category_products_products" (
                "categoryId" integer NOT NULL,
                "productsId" integer NOT NULL,
                CONSTRAINT "PK_e3d34c2352e8f5b24ab5f9776b2" PRIMARY KEY ("categoryId", "productsId")
            )
        `);
        await queryRunner.query(`
            CREATE INDEX "IDX_ae02308c93d865ed3dbaa6097f" ON "category_products_products" ("categoryId")
        `);
        await queryRunner.query(`
            CREATE INDEX "IDX_414c8fc7ae52afaf7b31750fac" ON "category_products_products" ("productsId")
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "category_products_products"
            ADD CONSTRAINT "FK_ae02308c93d865ed3dbaa6097f8" FOREIGN KEY ("categoryId") REFERENCES "category"("id") ON DELETE CASCADE ON UPDATE CASCADE
        `);
        await queryRunner.query(`
            ALTER TABLE "category_products_products"
            ADD CONSTRAINT "FK_414c8fc7ae52afaf7b31750facf" FOREIGN KEY ("productsId") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "category_products_products" DROP CONSTRAINT "FK_414c8fc7ae52afaf7b31750facf"
        `);
        await queryRunner.query(`
            ALTER TABLE "category_products_products" DROP CONSTRAINT "FK_ae02308c93d865ed3dbaa6097f8"
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            DROP INDEX "public"."IDX_414c8fc7ae52afaf7b31750fac"
        `);
        await queryRunner.query(`
            DROP INDEX "public"."IDX_ae02308c93d865ed3dbaa6097f"
        `);
        await queryRunner.query(`
            DROP TABLE "category_products_products"
        `);
        await queryRunner.query(`
            DROP TABLE "customer"
        `);
